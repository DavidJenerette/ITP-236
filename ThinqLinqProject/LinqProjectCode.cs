...
namespace ThinqLinqProject
{
    ...
    {
        public const string StudentName = "David Jenerette";             //--< START HERE WITH YOUR NAME <<<
        ...
        /// </summary>
        public decimal TotalCost => SalesOrders.Sum(so => so.SalesOrderParts.Sum(sop => sop.ExtendedCost));
        /// <summary>
        /// GrossProfit is the difference between TotalSales and TotalCost
        /// </summary>
        public decimal GrossProfit => SalesOrders.Sum(so => so.SalesOrderParts.Sum(sop => sop.ExtendedPrice) - so.SalesOrderParts.Sum(sop => sop.ExtendedCost)
    );

        /// <summary>
        /// ItemsSold is the sum of the SalesOrders' SalesOrderParts Quantities
        /// </summary>
        public int ItemsSold => SalesOrders.Sum(so => so.SalesOrderParts.Sum(sop => sop.Quantity));
    ...
    public partial class Part
    {
        ...
        /// </summary>
        public int QuantityOnHand => new[] { ReceivedUnits - SpoiledUnits - ShippedUnits }.Sum();
    ...
    public partial class SalesOrder
    {
        ...
        /// </summary>
        decimal OrderCost => SalesOrderParts.Sum(sop => sop.ExtendedPrice);
        /// <summary>
